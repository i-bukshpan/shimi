  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-[40] bg-gradient-to-r from-amber-400 to-orange-400 text-white px-4 py-4 sm:py-3 rounded-full shadow-2xl hover:scale-105 transition-all flex items-center gap-2 animate-bounce"
        title="מה עושים כאן?"
      >
