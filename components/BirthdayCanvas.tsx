      ...
      <ReactFlowProvider>
        ...
        <div className="w-full h-full block">
          ...
          >
            ...
            <Controls 
              className="bg-white/90 backdrop-blur-md shadow-2xl border border-stone-200/50 rounded-2xl overflow-hidden !bottom-[150px] sm:!bottom-24 !left-6 flex flex-col gap-1 p-1"
